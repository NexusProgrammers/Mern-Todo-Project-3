...
export interface FontFamily extends OverridableRecord<DefaultFontFamily, FontFamilyOverrides, string> {
}
...
export interface FontWeight extends OverridableRecord<DefaultFontWeight, FontWeightOverrides, string | number> {
}
...
export interface LineHeight extends OverridableRecord<DefaultLineHeight, LineHeightOverrides, string | number> {
}
...
export interface LetterSpacing extends OverridableRecord<DefaultLetterSpacing, LetterSpacingOverrides, string> {
}
...
export interface TypographySystem extends OverridableRecord<DefaultTypographySystem, TypographySystemOverrides, CSSObject> {
}

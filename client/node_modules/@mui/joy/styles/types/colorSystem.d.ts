...
export interface PaletteVariant extends Record<`${DefaultVariant}${DefaultProperty}` | `${DefaultVariant}${DefaultState}${DefaultProperty}`, string> {
}
...
export interface PaletteRange extends OverridableRecord<DefaultPaletteRange, PaletteRangeOverrides, string> {
}
...
export interface PaletteCommon extends OverridableRecord<DefaultPaletteCommon, PaletteCommonOverrides, string> {
}
...
export interface PaletteText extends OverridableRecord<DefaultPaletteText, PaletteTextOverrides, string> {
}
...
export interface PaletteBackground extends OverridableRecord<DefaultPaletteBackground, PaletteBackgroundOverrides, string> {
}
...
export interface PalettePrimary extends OverridableRecord<PaletteRange, PalettePrimaryOverrides, string> {
}
export interface PaletteNeutralOverrides {
}
export interface PaletteNeutral extends OverridableRecord<PaletteRange & {
    plainHoverColor: string;
    outlinedHoverColor: string;
    softHoverColor: string;
}, PaletteNeutralOverrides, string> {
}
export interface PaletteDangerOverrides {
}
export interface PaletteDanger extends OverridableRecord<PaletteRange, PaletteDangerOverrides, string> {
}
export interface PaletteInfoOverrides {
}
export interface PaletteInfo extends OverridableRecord<PaletteRange, PaletteInfoOverrides, string> {
}
export interface PaletteSuccessOverrides {
}
export interface PaletteSuccess extends OverridableRecord<PaletteRange, PaletteSuccessOverrides, string> {
}
export interface PaletteWarningOverrides {
}
export interface PaletteWarning extends OverridableRecord<PaletteRange, PaletteWarningOverrides, string> {
}
...
export type PaletteOptions = MergeDefault<Palette, {
